        ...
        <div className={styles.textContainer1}>
          ...
          <div className={styles.termsContainer}>
            <p>
              ...
              carefully before using the www.azbytegems.com website (the
              "Service") operated by Azbyte Gems ("us", "we", or "our"). Your
            ...
            <p>
              ...
              our sole discretion, if we find excessive access to Azbyte Gems'
              site or attempts to hack into our site or other security risks
              from those IPs, or for other reasons, including but not limited to
              a breach of the Terms. All provisions of the Terms which by their
